...
if __name__ == '__main__':
    ...
    if cfg.MODEL.WEIGHTS != '':
        ...
        for batch in test_loader:
            ...
            rst, det_rst = model.predict(texts)

            for src_text, tgt_text, det_label, pre_token_ids in zip(texts, gts, det_labels, rst):
        ...
        # print(out_df)
        # out_df.to_csv(f'{cfg.DATASETS.TEST}.pre_sota',
